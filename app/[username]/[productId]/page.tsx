...
import { LeadMagnetModal } from "@/components/storefront/LeadMagnetModal";
...
export default async function ProductPage({
  ...
  const { data: product } = await supabaseAdmin
    .from("products")
    .select("id, name, description, price, currency, cover_image_url, compare_at_price, is_lead_magnet, creator_id")
    .eq("id", productId)
